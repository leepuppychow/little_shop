...
item1 = Item.create!(name: "Green Lightsaber", description: "the best", price: 100.0, image: "http://images.buystarwarstoys.com/products/9288/1-1/ahsoka-tano-toy-lightsaber.jpg", status: "complete", category: category1)
item2 = Item.create!(name: "Blue Lightsaber", description: "the second best", price: 200.0, image: "https://target.scene7.com/is/image/Target/17133411?wid=520&hei=520&fmt=pjpeg", status: "complete", category: category2)
